            ...
            <div className="editProfileRightTop">
              <div className="editProfileCover">
                <div className="editCoverImg">
                  {backimgfile ? (
                    <img
                      src={URL.createObjectURL(backimgfile)}
                      alt=""
                    ...
                    <motion.img
                      src={
                        user.coverPicture
                          ? PUBLIC_FOLDER_URL + user.coverPicture
                  ...
                  <form
                    className="editShareButtons"
                    onSubmit={e => backImghandleSubmit(e)}
                  >
                    <div className="editShareOptions">
                      <label className="editShareOption" htmlFor="backfile">
                        <Image
                          className="editCoverShareIcon"
                          htmlColor="gray"
                        />
                      ...
                      {backimgfile && (
                        <button
                          className="editEditCancelImg"
                          onClick={() => backimgsetFile(null)}
                        >
                          キャンセル
                        </button>
                      )}
                      <button className="editShareButton" type="submit">
                        保存
                      </button>
                    </div>
                  </form>
                  ...
                  <div className="editUserImg">
                    {file ? (
                      ...
                      <motion.img
                        src={
                          user.profilePicture
                            ? PUBLIC_FOLDER_URL + user.profilePicture
                            : PUBLIC_FOLDER + '/person/loading02.mp4'
                        }
                        alt=""
                        initial={{ opacity: 0 }}
